...
Ext.define('xdfn.ux.portal.PortalPanel', {
    ...
    requires: [
        ...
        'xdfn.ux.portal.PortalDropZone',
        'xdfn.ux.portal.PortalColumn'
    ],
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('xdfn.ux.portal.PortalDropZone', this, this.dropConfig);
    },
