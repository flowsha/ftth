/**
 * @class xdfn.ux.portal.PortalDropZone
 * @extends Ext.dd.DropTarget
 * Internal class that manages drag/drop for {@link xdfn.ux.portal.PortalPanel}.
 */
Ext.define('xdfn.ux.portal.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        xdfn.ux.portal.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        xdfn.ux.portal.PortalDropZone.superclass.unreg.call(this);
    }
});
